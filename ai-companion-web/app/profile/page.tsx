...
export default async function ProfilePage() {
  ...
  const copy = {
    ...
    title: pickText(locale, { zh: "个人战绩中心", en: "Profile Center" }),
    ...
    <div className="min-h-screen bg-slate-950 p-4 text-slate-100 md:p-8">
      <div className="mx-auto max-w-6xl space-y-6">
        ...
        <Link href="/profile/analysis" className="group block">
          <div className="relative rounded-2xl bg-gradient-to-br from-indigo-600 via-purple-600 to-pink-600 p-1 shadow-2xl transition-all duration-300 hover:scale-[1.02] hover:shadow-indigo-500/50">
            <div className="absolute -right-3 -top-3 rounded-full bg-violet-500 px-3 py-1 text-xs font-bold text-white shadow-lg">
              Hot
            </div>
        ...
        <div className="flex items-center justify-between rounded-xl border border-violet-500/20 bg-gradient-to-r from-violet-900/50 to-fuchsia-900/40 p-6 transition-all hover:from-violet-900/70 hover:to-fuchsia-900/60">
          ...
          <Link href="/leaderboard">
            <Button className="bg-white font-bold text-violet-900 hover:bg-violet-50">
          ...
          <Card className="border-slate-800 bg-slate-900 md:col-span-1">
            <CardHeader className="flex flex-row items-center gap-4">
              ...
              <div>
                ...
                <CardDescription className="text-slate-400">ID: {user.email}</CardDescription>
              </div>
            </CardHeader>
